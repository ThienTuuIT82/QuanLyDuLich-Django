# Generated by Django 3.2.5 on 2021-10-11 16:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle', models.CharField(choices=[('OTO', 'Ô tô'), ('YACHT', 'Du thuyền'), ('PLANE', 'Máy bay')], default=Tours.models.Vehicle['OTO'], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('MALE', 'Nam'), ('FEMALE', 'Nữ')], default=Tours.models.Gender['MALE'], max_length=20, null=True)),
                ('birth', models.DateField(blank=True, null=True)),
                ('phone', models.CharField(blank=True, max_length=12, null=True)),
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('BUSINESS', 'Nhân viên kinh doanh'), ('SALESMAN', 'Nhân viên bán hàng'), ('EMPLOYEE_MANAGER', 'Quản lý nhân sự'), ('MANAGER', 'Quản lý'), ('USER', 'Khách hàng')], default=Tours.models.Role['USER'], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_date', models.DateTimeField(auto_now=True, null=True)),
                ('tour', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Tours.tours')),
            ],
        ),
        migrations.AddField(
            model_name='tours',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_tour', related_query_name='user_tour', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='TourBooking',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_date', models.DateTimeField(auto_now=True, null=True)),
                ('comment_tour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Tours.commenttour')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Tours.commentblog')),
